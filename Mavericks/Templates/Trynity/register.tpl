...
<head>
	<meta charset="utf-8">
	<title>{$SITENAME} »  Reserva suite gratis en el mayor Hotel virtual. Queda con tus viej@s amig@s, haz nuev@s, juega, chatea, crea tu avatar, tus habitaciones y más aún... </title>
...
<body>
	...
	<script type="text/javascript" src="{$CDN}/js/register.js"></script>
